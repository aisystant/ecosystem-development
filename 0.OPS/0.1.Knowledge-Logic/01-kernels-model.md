...
**S2R как формат структуры:** S2R — это методология **организации репозиториев** (измерение "Форма"), а не уровень знаний. S2R определяет структуру ядер, матрицу 3×3, семейства F1-F9, но НЕ определяет содержание (это делает FPF/SPF) или процесс производства (это делает SPF).

**Подробнее о методологии:** [Документация S2R](https://github.com/TserenTserenov/s2r)

**Три измерения организации знаний:** [[10-knowledge-architecture.md]]
