...
### B. MCP-сервер персональных руководств (PersonalGuide MCP / `S.PersonalGuideGenerator`)

**Тип:** ИИ-ассистент (ai_role: core) — см. [[Описание ИИ-ассистента Генератор персонального руководства 3.2]]
...
> **Примечание:** Концепция «персональное задание как центр, руководство как часть задания» описана в [[Описание цифрового двойника 3.2#2.3. Персональное задание и Генератор руководства]].
