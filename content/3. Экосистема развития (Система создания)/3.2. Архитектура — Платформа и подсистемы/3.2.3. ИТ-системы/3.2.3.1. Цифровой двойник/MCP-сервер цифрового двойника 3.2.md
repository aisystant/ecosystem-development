...
description: "Описание MCP-сервера над Моделью данных цифрового двойника: архитектура, tools, сценарии использования для ИИ-Проводника"
---
...
- **Входы:** `learner_id`, `period_start`, `period_end` или предустановленный период
...
- **Входы:** `learner_id`, `period` (4_недели, 8_недель, 3_месяца)
...
- **Входы:** `learner_id`, `stage` (Случайный/Практикующий/Систематический/Дисциплинированный/Проактивный), `reason`, `metrics_snapshot`
...
- **Входы:** `learner_id`, структура маршрута (цели, шаги, связи)
- **Выход:** id маршрута/версии

#### B3. `update_route_step_status`

- **Назначение:** обновить статус шага
- **Входы:** `learner_id`, `step_id`, `new_status`, комментарий
...
- **Входы:** `learner_id`, `session_type` (разовая, еженедельная, переход, реактивация), `input_summary`, `actions`, `used_data_refs`
- **Выход:** id сессии
...
- **Входы:** `learner_id`, список показателей, период
