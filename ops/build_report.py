...
"""
    ...
    def _architecture_heatmap(self) -> str:
        ...
        for family_id in ["F0", "F1", "F2", "F3", "F4", "F5", "F6", "F7", "F8", "F9"]:
            ...
            # 🟡 Частичный: 30–69% типичных документов ИЛИ документы неполные
            ...
            if typical_ratio >= 0.7 and non_empty_ratio >= 0.5:
            ...
            elif typical_ratio >= 0.3 or (count > 0 and non_empty_ratio >= 0.3):
                status = "🟡"
                ...
                if count == 0:
                    ...
                    comment = "Только заглушки или неполные"
